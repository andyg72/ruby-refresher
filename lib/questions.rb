...
def get_elements_until_greater_than_five(array)
  array.first(array.find_index{ |n| n > 5})
end
...
def remove_capital_letters_from_string(string)
  string.chars.reject{ |letter| letter == letter.upcase && letter != " " }.join
end
...
def titleize_a_string(string)
  string.split(" ").map.with_index {|w, i| ['a','the','and'].include?(w) && i != 0 ? w : w.capitalize}.join(" ")
end
